import {
  ...
  Lightbulb, Star, GitBranch, ShoppingBag, Wallet
} from "lucide-react";
...
export const CATEGORIES = [
  ...
  { key: "shopping", label: "Shopping", icon: ShoppingBag, color: "#EC4899", bg: "#FCE7F3" },
  { key: "finance", label: "Finance", icon: Wallet, color: "#6366F1", bg: "#E0E7FF" },
];
...
//IGNORE THIS SECTION line 74 - line 125
/* ─────────────────────────────────────────
...
//IGNORE THIS SECTION line 155 - line 228
/* ─────────────────────────────────────────
   SETTINGS — APPEARANCE
───────────────────────────────────────── */
